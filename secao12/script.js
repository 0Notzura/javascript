...
//retorna o numero em milisegundos
console.log(future.getTime());
console.log(new Date(2142256980000));
console.log(Date.now());//data atual
//metodos para setar valores separadamente
...
const now2 = new Date();
    const options = {
      ...
      minute: "numeric",
      day: "numeric",
      month: "numeric",//pd ser long ou double
      year: "numeric",
      // weekday: 'long',
    };
    ...
    labelDate.textContent = new Intl.DateTimeFormat(
      'pt-BR',/*navigate.language funciona pra pegar de onde ta sendo acessado*/
      options
    ).format(now2);
